...
use App\Filament\Resources\Motorwash\MotorwashVisitHistoryResource\Pages;
...
class MotorwashVisitHistoryResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMotorwashVisitHistories::route('/'),
        ];
    }
