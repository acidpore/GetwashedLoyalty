...
use App\Filament\Resources\Carwash\CarwashVisitHistoryResource\Pages;
...
class CarwashVisitHistoryResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListCarwashVisitHistories::route('/'),
        ];
    }
