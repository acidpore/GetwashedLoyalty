            ...
            Forms\Components\Section::make('Coffee Shop Loyalty')
                ->schema([
                    ...
                    Forms\Components\TextInput::make('coffeeshop_total_visits')
                        ...
                        ->numeric()
                        ->default(0),
                    Forms\Components\Placeholder::make('coffeeshop_last_visit_at_display')
                        ->label('Last Visit')
                        ->content(fn ($record) => $record->coffeeshop_last_visit_at?->format('d M Y H:i') ?? '-')
                        ->hint('Auto-recorded'),
                ]),
        ]);
    }
                ...
                Tables\Actions\Action::make('export')
                    ...
                    ->form([
                        Forms\Components\Radio::make('format')
                            ...
                            ->descriptions([
                                'standard' => 'Export coffee shop customer details (Name, Phone, Points, Total Visits, Last Visit)',
                    ...
                    ->action(function (array $data) {
                        ...
                        if ($data['format'] === 'maxchat') {
                            ...
                            $headers = [
                                ...
                                'Content-Disposition' => 'attachment; filename="coffeeshop_maxchat_broadcast_' . now()->format('Y-m-d') . '.csv"',
                            ];
