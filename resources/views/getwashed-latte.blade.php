...
<body class="font-display bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-slate-200">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 grid md:grid-cols-3 gap-8">
        ...
        <div class="flex flex-col gap-4">
            ...
            <a class="flex items-center gap-2 text-sm hover:text-primary transition-colors" href="tel:+628132264891">
                <span class="material-symbols-outlined text-lg">call</span>+62 813-2264-891
            </a>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <a class="hover:text-primary transition-colors" target="_blank" href="https://www.tiktok.com/@getwashed16">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
